...
export default (): void => {
  describe('Comment log messages with the logType setting being set to error', () => {
    Mocha.before(async () => {
      await openDocument(
        ProgrammingLanguage.JAVASCRIPT,
        'comment-feature',
        'commentErrorMessages.js',
      );
    });
    Mocha.after(async () => {
    ...
    it('Should comment log messages with the error as the log type', async () => {
